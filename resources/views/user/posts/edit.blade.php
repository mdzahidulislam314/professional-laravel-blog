      ...
      <div class="container">
          ...
          <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form" action="{{route('user.posts.update',$post->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <div class="checkbox checkbox-primary">
                                    <input name="status" value="1" id="checkbox1" {{$post->status == true ? 'checked' : ''}} type="checkbox">
                                    <label for="checkbox1">
                                        Publish
                                    </label>
                                </div>
        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <textarea name="editor1">{{$post->editor1}}</textarea>
